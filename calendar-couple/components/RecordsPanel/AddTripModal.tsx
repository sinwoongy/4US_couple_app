      ...
      <div className="map-modal-box" onClick={(e) => e.stopPropagation()}>
        <div className="map-modal-header">
          <div>
            ...
            <p style={{ fontSize: 13, color: "#6366f1", fontWeight: 500, marginTop: 2 }}>
              {sidoName} · {sigunguName}
            </p>
          </div>
          <button onClick={onClose} style={{ fontSize: 24, color: "#9ca3af", background: "none", border: "none", cursor: "pointer", lineHeight: 1 }}>
            ×
          </button>
        </div>
